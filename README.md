...
Created 3 main classes. Input class is a static class that handles user input. Posts is for creating posts with a author, title and a text.
Junit tests are located in test folder. Not alot of test for now because most of the program is built on user input.
